...
{
    class TemparatureUnits
    {
        
        public void UnitConvertion(float temp,string tempCheck)
        {
            Console.WriteLine(" entet the second parameter temperatues in 'farahenite' or 'celcius'");
